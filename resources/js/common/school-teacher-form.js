...
import AreaSelector from '../components/common/area-selector.vue'
        ...
        try {
          this.form.forEach(group => {
            group.fields.forEach(field => {
              if (field.validator && field.validator.required && !field.value) {
            ...
            fields: [{
              ...
              },
              {
                ...
                validator: [{
                  ...
                  trigger: 'blur',
                  validator: (r, v, c) => {
                    if (!/^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/.test(v)) {
