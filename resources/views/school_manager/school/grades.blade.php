                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle">
                                ...
                                <tr>
                                    ...
                                    <th>班主任</th>
                                    <th>班长</th>
                                    <th class="text-center">学生数 正常/休学/退学</th>
                                ...
                                @foreach($grades as $index=>$grade)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="students-counter" href="{{ route('teacher.grade.students',['type'=>User::STATUS_DROP_OUT ,'grade_id'=>$grade->id]) }}">{{ $grade->studentsOutOfSchoolCount() }}</a>
                                            <a class="students-counter" href="{{ route('teacher.grade.students',['type'=>User::STATUS_SUSPENSION,'grade_id'=>$grade->id]) }}">{{ $grade->studentsSuspensionSchoolCount() }}</a>
                                        </td>
                                        <td class="text-center">
